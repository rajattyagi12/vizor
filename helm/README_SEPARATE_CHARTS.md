...
| vizor-platform-support | `helm/vizor-platform-support` | Caddy (api-proxy), optional Mailhog, optional SFTPGo + Dapr binding |
...
| vizor-traffic | `helm/vizor-traffic` | Ingress, HPA, optional Mailhog ingress, optional observability (Loki, Grafana, Promtail) |
